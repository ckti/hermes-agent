...
def assemble_api_request(
    ...
    # Filter after plugin selection so it cannot reintroduce disabled context.
    ...
    tools_for_api = agent.tools if getattr(agent, "send_tool_definitions", True) is not False else []
